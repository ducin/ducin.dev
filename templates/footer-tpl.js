...
<footer id="footer">
  <ul class="icons">
    <li><a target="_blank" href="/feed.xml" class="icon fa-rss"><span class="label">RSS</span></a></li>
    ...
    <li><a href="mailto:tomasz@ducin.dev" class="icon fa-envelope-o"><span class="label">Email</span></a></li>
  </ul>
  <ul class="copyright">
